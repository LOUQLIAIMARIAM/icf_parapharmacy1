...
//   const complement({Key? key}) : super(key: key);
//
//   @override
...
//     return Scaffold(
//       appBar: AppBar(
//         title: Text('compléments alimentaires'),
//         actions: <Widget>[
//           IconButton(
...
class complement extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
      ...
      body: StreamBuilder(
        ...
        builder: (context, snapshot) {
          ...
          return ListView.builder(
            ...
            itemBuilder: (context, index) {
              var antiCollection = categoryDocs?[index].reference.collection('compléments-alimentaires');
