...
class maman extends StatefulWidget {
  const maman({Key? key}) : super(key: key);

  @override
  State<maman> createState() => _mamanState();
}

class _mamanState extends State<maman> {
  Cart cart = Cart();
