...
class cheveux extends StatefulWidget {
  const cheveux({Key? key}) : super(key: key);

  @override
  State<cheveux> createState() => _cheveuxState();
}

class _cheveuxState extends State<cheveux> {
  Cart cart = Cart();
