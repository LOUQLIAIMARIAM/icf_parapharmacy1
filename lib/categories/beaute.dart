...
class beaute extends StatefulWidget {
  const beaute({Key? key}) : super(key: key);

  @override
  State<beaute> createState() => _beauteState();
}

class _beauteState extends State<beaute> {
  Cart cart = Cart();
