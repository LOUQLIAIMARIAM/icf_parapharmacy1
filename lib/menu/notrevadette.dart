...
class notrevadette extends StatefulWidget {
  const notrevadette({Key? key}) : super(key: key);

  @override
  State<notrevadette> createState() => _notrevadetteState();
}

class _notrevadetteState extends State<notrevadette> {
  Cart cart = Cart();
