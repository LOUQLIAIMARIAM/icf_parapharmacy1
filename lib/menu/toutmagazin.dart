...
class toutmagazin extends StatefulWidget {
  const toutmagazin({Key? key}) : super(key: key);

  @override
  State<toutmagazin> createState() => _toutmagazinState();
}

class _toutmagazinState extends State<toutmagazin> {
  Cart cart = Cart();
  List<Product> products = [
    ...
    Product(
      name: '3M Steri-Strip ',
      price: 'MAD15.00',
      imageUrl: 'assets/categories/corps/3m-steristrip.jpg',
      isFavorite: false,
    ),
    Product(
      name: '8882 Crème\nDe Jour',
      price: 'MAD185.00',
      imageUrl: 'assets/categories/corps/8882-01.jpg',
      isFavorite: false,
    ),
    Product(
      name: 'ACM\nCicastim Arnica',
      price: 'MAD100.00',
      imageUrl: 'assets/categories/corps/a-01.jpg',
      isFavorite: false,
    ),
    Product(
      name: 'A-Derma\nPain Surgras',
      price: 'MAD63.00',
      imageUrl: 'assets/categories/corps/a-derma-pain-surgras-01.jpg',
      isFavorite: false,
    ),
    Product(
      name: 'Mixa Cica-Crème',
      price: 'MAD63.00',
      imageUrl: 'assets/categories/corps/cica-creme.jpg',
      isFavorite: false,
    ),
    Product(
      name: 'ROGE CAVAILLES',
      price: 'MAD63.00',
      imageUrl:'assets/categories/corps/ffff.jpg',
      isFavorite: false,
    ),
    Product(
      name: 'ORALEX Brosse',
      price: 'MAD30.00',
      imageUrl: 'assets/categories/corps/oralex.jpg',
      isFavorite: false,
    ),
    Product(
      name: 'A-Derma\nExomega',
      price: 'MAD78.00',
      imageUrl: 'assets/categories/corps/qssqqsqs.jpg',
      isFavorite: false,
    ),
    Product(
      name: 'ALGOTHERM\nALGOESSENTIAL',
      price: 'MAD869.00',
      imageUrl: 'assets/categories/beaute/algo.png',
      isFavorite: false,
    ),
    Product(
      name: 'Maybelline Superstay',
      price: 'MAD100.00',
      imageUrl: 'assets/categories/beaute/mybe.jpg',
      isFavorite: false,
    ),
    Product(
      name: 'DERMAGOR Psocalm',
      price: 'MAD108.00',
      imageUrl: 'assets/categories/beaute/dermagor.jpg',
      isFavorite: false,
    ),
    Product(
      name: 'Brosse\nSuper-Sonique',
      price: 'MAD110.00',
      imageUrl: 'assets/categories/beaute/bross.jpg',
      isFavorite: false,
    ),
    Product(
      name: 'Essence Clear&Matt',
      price: 'MAD65.00',
      imageUrl: 'assets/categories/beaute/ecran.jpg',
      isFavorite: false,
    ),
    Product(
      name: 'Maybelline FIT Me! ',
      price: 'MAD99.00',
      imageUrl:'assets/categories/beaute/fend.jpg',
      isFavorite: false,
    ),
    Product(
      name: 'Garnier SkinActive ',
      price: 'MAD64.00',
      imageUrl: 'assets/categories/beaute/garnier.jpg',
      isFavorite: false,
    ),
    Product(
      name: 'Garnier Skin\nActive Pure',
      price: 'MAD69.00',
      imageUrl: 'assets/categories/beaute/garnoir.jpg',
      isFavorite: false,
    ),
    Product(
      name: 'LOréal Highlighter\nInfaillible',
      price: 'MAD100.00',
      imageUrl: 'assets/categories/beaute/inf.jpg',
      isFavorite: false,
    ),
    Product(
      name: 'Isdinceutics K-OX EYES',
      price: 'MAD300.00',
      imageUrl: 'assets/categories/beaute/isdin.jpg',
      isFavorite: false,
    ),
    Product(
      name: 'OREAL Mascara\nFaux Cils X',
      price: 'MAD138.00',
      imageUrl: 'assets/categories/beaute/mascara.jpg',
      isFavorite: false,
    ),
    Product(
      name: 'Klorane Myrte Shampooing',
